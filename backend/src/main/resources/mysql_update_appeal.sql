...
-- Add proof_image column if table already exists (for update scenarios)
ALTER TABLE IF EXISTS blacklist_appeals ADD COLUMN IF NOT EXISTS proof_image VARCHAR(512);
